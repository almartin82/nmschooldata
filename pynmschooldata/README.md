...
Python wrapper for New Mexico school enrollment data.

This is a thin rpy2 wrapper around the [nmschooldata](https://github.com/almartin82/nmschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `nmschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/nmschooldata")

# Then install the Python package
pip install pynmschooldata
```
...
# Fetch one year
df = nm.fetch_enr(2025)

# Fetch multiple years
df_multi = nm.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
