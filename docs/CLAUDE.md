...
| Python tests | `pytest tests/test_pynmschooldata.py -v`                                       | Python wrapper works correctly                 |
...
system("pip install -e ./pynmschooldata && pytest tests/test_pynmschooldata.py -v")
...
0 errors, 0 warnings - \[ \] `pytest tests/test_pynmschooldata.py` — all
tests pass - \[ \]
